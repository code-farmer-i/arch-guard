...
> 本表是**完整设计**（含未实现项）。**已实现并带夹具的 104 条**（以 `arch-guard --stats` / `coreRules` 为准）：
> `S00–S06`、`S08`、`S09`、`S11–S32`、`S34–S46`、`D01–D10`、`D10b`、`D11–D20`、`D21–D28`、`C01–C07`、`P01–P08`、`P11`、`P12`、`H06–H09`、`H12`、`H13`、`M02–M09`。
