...
| **想看「配全」长什么样**         | [`examples/full/`](../examples/full/) —— 一个范式 + 5 个域 + 8 个面 + 结构声明全配的最小应用：`pnpm guard:full` 跑出来是 **98/98 规则在跑、0 finding、0 停用**。最短可用的对照是 [`examples/minimal/`](../examples/minimal/)（69/98） |
