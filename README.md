...
- [x] 结构域：角色表与目录契约（S00–S06、S08、S09、S11–S24）——含**层序 / 组隔离 / 公开面**三条通用图规则
...
- [x] 共 **71 条规则**（结构 S · 设计 D · 文案 C · 依赖 P · 退化 H · 度量 M；以 `--stats` 为准），**71/71 有夹具**（夹具全部 `exact`：多报也报错）
...
- [ ] 数据层的**取数落点**（`useQuery` 该挂在哪）与 `use*Store` 形态
